...
// Voltage divider value => 300k + 100k voltage divider on VBAT = (1.5M / (1M + 1.5M))
#define VBAT_DIVIDER (0.7F)
...
#define PIN_SPI_MISO (0 + 3) // P0.02
#define PIN_SPI_MOSI (0 + 2) // P0.03
